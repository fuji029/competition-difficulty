...
checkpoint = pl.callbacks.ModelCheckpoint(
    ...
    save_weights_only=True, dirpath=f"model/{nowtime}"
)
...
with open(f"model/{nowtime}/log.txt", "w") as f:
    ...
    f.write(
        f"QCK={cohen_kappa_score(dev_label, pred_label, weights='quadratic')}\n")
    f.write(f"{classification_report(dev_label, pred_label)}\n")
